...
export default function App() {
 ...
 useEffect(()=>{
  const fetchData = async ()=>{
    try{
      const response = await axios.get("https://artinetback.onrender.com/api/fetch");
  ...
  const handleDisplay = async(e)=>{
    e.preventDefault();
     ...
     try{
      const response = await axios.post("https://artinetback.onrender.com/api/posts", {write, title});
